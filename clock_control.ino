...
#define WAIT_TIME 5 // in ms (time after arbitration)
#define REPEAT_TIME  163 // in us, affected by INJECT_LENGTH (time btwn injections)
...
#define MAX_INJECT 8
  ...
  while (num_inject < MAX_INJECT) {
    inject();
    delayMicroseconds(REPEAT_TIME + dly);
    dly += 100;
  }
...
#define INJECT_LENGTH 12 + num_inject * 10 // +1 in reality, +1 here is -1 in REPEAT_TIME
